...
def get_dictionaries(path=os.path.dirname(os.getcwd()) + '/data/issuers_modified.xlsx'):
...
def split_news_on_companies(text, dictionary_companies, all_tickers, dictionary_companies_by_ticker):
